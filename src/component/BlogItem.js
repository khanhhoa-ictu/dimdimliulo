...
function BlogItem() {
    return (
        ...
        <div className="card card-inverse">
            ...
            <p className=" lead card-text text-shadow text-white  break-word w-50 d-xs-block text" >Giống như bao cô gái khác, dù 18 tuổi, 28 tuổi, 38 tuổi đều thích hoài niệm về quá khứ.
